export type GameDomain = "strength" | "precision" | "magic";

export type GameClassConfig = {
  key: string;
  name: string;
  description: string;
  role: string;
...
export const GAME_CLASSES: GameClassConfig[] = [
  {
    key: "guardian",
    name: "Страж",
...
export function getClassConfig(classKey: string): GameClassConfig {
...
export function classListText(): string {
