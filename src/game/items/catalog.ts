export type ItemSlot = "weapon" | "armor" | "accessory" | "ability" | "consumable" | "quest";
...
export type ItemConfig = {
  ...
  slot: ItemSlot;
  description: string;
  bonusType?: "strength" | "precision" | "magic" | "hp" | "mana" | "stamina";
  bonusValue?: number;
  consumableEffect?: "heal_hp" | "restore_mana" | "restore_stamina" | "cleanse" | "rebirth";
};
...
export function getItemConfig(itemKey: string): ItemConfig {
