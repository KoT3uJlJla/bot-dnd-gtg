...
import { eventStatusText, joinActiveEvent, leaveActiveEvent, performDeathSave, startIceWastelandEvent, stopActiveEvent } from "../../game/events/eventService.js";
...
export function registerEventCommands(bot) {
