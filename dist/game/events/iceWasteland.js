...
export const ICE_WASTELAND_EVENT = {
            ...
            scenes: [
                {
                    ...
                    publicText: "Звено выходит на белую равнину. Под снегом хрустит старый наст, а вдалеке мерцают входы в пещеру.",
                ...
                },
                {
                    key: "blizzard",
                    title: "Буран",
                    publicText: "Буран сбивает дыхание и стирает следы. Нужны воля, руны или верный проводник.",
                ...
                },
                {
                    ...
                    publicText: "Лед под ногами идет сеткой трещин. Один неверный шаг может утащить аватара в черную воду.",
                    challengeDomain: "precision",
                    threshold: 6,
                    failureDamage: 2
                },
                ...
                },
                {
                    ...
                    publicText: "Мини-босс ревет так, что с ближайших скал сыплется снег. Он прикрывает вход к ледяной пещере.",
            ...
            scenes: [
                {
                    ...
                    publicText: "Скелет третьего акта: трехфазный босс с меняющимися уязвимостями доменов.",
                    challengeDomain: "magic",
                    threshold: 12,
                    failureDamage: 3
                }
...
export function getScene(act, sceneIndex) {
...
export function getNextScene(act, sceneIndex) {
    const actConfig = ICE_WASTELAND_EVENT.acts.find((candidate) => candidate.number === act);
